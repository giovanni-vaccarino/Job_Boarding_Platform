...
namespace backend.Migrations
{
    ...
    [Migration("20241225023533_UserVerificationAttribute")]
    partial class UserVerificationAttribute
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Data.Entities.Answer", b =>
                {
                    ...
                    b.Property<int>("InternshipQuestionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("InternshipQuestionId");
            ...
            modelBuilder.Entity("backend.Data.Entities.Internship", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("backend.Data.Entities.InternshipQuestion", b =>
                {
                    ...
                    b.HasIndex("InternshipId", "QuestionId")
                        .IsUnique();
            ...
            modelBuilder.Entity("backend.Data.Entities.Answer", b =>
                {
                    ...
                    b.HasOne("backend.Data.Entities.InternshipQuestion", "InternshipQuestion")
                        .WithMany()
                        .HasForeignKey("InternshipQuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Application");

                    b.Navigation("InternshipQuestion");
                });
